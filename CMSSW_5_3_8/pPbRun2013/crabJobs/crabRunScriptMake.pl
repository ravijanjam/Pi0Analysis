...
my $topName = "/home/sharmam/CMSSW_5_3_8_HI_patch2/src/Pi0Analysis/EcalFlowNtp/pPbRun2013/crabJobs/";
if(-e $topName) {
...
my $lastRun = 1;  # end position in arrayOfRunNumbers counting from 1
...
#
if(-e "pPbData2013_Luminosity.csv") {
    open(LUMIFILE, "pPbData2013_Luminosity.csv");
}
else {
