...
process.EcalFlowNtpMult80 = process.EcalFlowNtp.clone(
    cutMultMin = cms.double(60),
    cutMultMax = cms.double(80)
    )

process.EcalFlowNtpMult100 = process.EcalFlowNtp.clone(
    cutMultMin = cms.double(80),
    cutMultMax = cms.double(100)
    )

process.EcalFlowNtpMult120 = process.EcalFlowNtp.clone(
...
process.Mult80 = cms.Path(
                        process.hltSingleTrigger *
                        process.PAcollisionEventSelection *
                        process.siPixelRecHits *
                        process.pileupVertexFilterCutGplus *
                        process.pACentrality *
                        process.EcalFlowNtpMult80 
                        )

process.Mult100 = cms.Path(
                        process.hltSingleTrigger *
                        process.PAcollisionEventSelection *
                        process.siPixelRecHits *
                        process.pileupVertexFilterCutGplus *
...
process.Mult120 = cms.Path(
                        process.hltSingleTrigger *
                        process.PAcollisionEventSelection *
                        process.siPixelRecHits *
                        process.pileupVertexFilterCutGplus *
                        process.pACentrality *
                        process.EcalFlowNtpMult120 
                        )

process.schedule = cms.Schedule(process.Mult20,process.Mult30,process.Mult40,process.Mult50,process.Mult60,process.Mult80,process.Mult100,process.Mult120)
