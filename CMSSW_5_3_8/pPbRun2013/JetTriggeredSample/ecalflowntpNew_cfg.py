...
process.hltJetTrigger.HLTPaths = ["HLT_PAJet80_NoJetID_v1",
                                  "HLT_PAJet80_NoJetID_v2"]
...
process.EcalFlowNtp.pi0HadronCorrelations = cms.bool(False)
process.EcalFlowNtp.etaHadronCorrelations = cms.bool(True)
