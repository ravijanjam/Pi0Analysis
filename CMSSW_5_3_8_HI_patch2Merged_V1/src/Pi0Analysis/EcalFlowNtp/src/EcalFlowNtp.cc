...

{
  ...
  clustS49Cut =  ps.getParameter<double>("clustS49Cut");  // introduced into python file as of April 30, 2014
  // from Monika - added by Ravi
...
//  doSwissThreshold_ = ps.getParameter<bool>("doSwissThreshold");
  ...
  cout << "\n The cluster S4/S9 cut is " << clustS49Cut << endl;
