...
class EcalFlowNtp : public edm::EDAnalyzer {
 ...
 private:
  ...
  int bins1;
  float clustEnrCut;
  float clustS49Cut;  // set in the python file as of April 30, 2014 
  float clustS1Cut;
  float clustS25Cut;
  ...
  TH1D *TimingAfter;
  // ================================================================ //
  // from Monika's Headers - added by Ravi
  TH1F *tPt_trg_; 
  TH1F *tPhi_trg_;
  TH1F *tEta_trg_;
  TH2F *effhisto;
  ...
  */
  ...
  void statusMessages(int i, double value);
