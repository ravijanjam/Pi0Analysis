...
my $storeDirectory = "/user/maguire/";
...
#
# Generate the list of files in this area (assume that the files have a 1March in their names)
#
`ls -al $storePath | grep 1March > storeFilesList.txt`;
