...
my $topName = "/gpfs22/home/maguirc/CMSSW_5_3_8_HI_patch2/src/Pi0Analysis/EcalFlowNtp/PAHighPt";
if(-e $topName) {
...
my $storeDirectory = "/gpfs22/home/maguirc/CMSSW_5_3_8_HI_patch2/src/Pi0Analysis/EcalFlowNtp/PAHighPt/crab_0_140303_182800/res/";
if(-e $storeDirectory) {
...
#
# Generate the list of files in this GPFS area (assume that the files have a key text in their names)
#
`ls -al $storeDirectory | grep "03Mar" > gpfsFilesList.txt`;
