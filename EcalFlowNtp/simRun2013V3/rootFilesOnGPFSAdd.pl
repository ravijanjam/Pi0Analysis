...
my $topName = "/gpfs22/home/maguirc/CMSSW_5_3_8_HI_patch2/src/Pi0Analysis/EcalFlowNtp/simRun2013V3";
if(-e $topName) {
...
my $storeDirectory = "/gpfs22/home/maguirc/CMSSW_5_3_8_HI_patch2/src/Pi0Analysis/EcalFlowNtp/simRun2013V3/crab_0_140519_205413/res/";
if(-e $storeDirectory) {
...
#
# Generate the list of files in this GPFS area (assume that the files have a 19May in their names)
#
`ls -al $storeDirectory | grep 19May > gpfsFilesList.txt`;
