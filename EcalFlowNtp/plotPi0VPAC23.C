...
void plotPi0_pPb2013(const int iOption = 2,        // default plotting choice of HBT correlations
		     ...
		     const float seedTimeCut = 0.0,           // fixed-size cut on time of the seed crystal (0 means no cut)
                     ...
                     const int highCrystalLimit = 2,        // upper limit for the crystal numbers
                     ...
                     const int highClusterPairCrystalSumLimit = 4,      // upper limit on the sum of the crystals in a cluster pair
  ...
  float fitStart = 0.090;   // 0.070 for parametrized background fit, 0.11 for mixed-event
  float fitEnd = 0.190;     // 0.220 for parametrized background, 0.159 for mixed-event
  ...
  if(multiplicityBin < -1 || multiplicityBin > 3) {
	...
	cout << "\n Using S4/S9 cluster cut = " << clustS49Cut << endl;
  ...
  if(abs(iOption) >= 10) { // using hTree to produce figures
    ...
    Float_t         S9Clu[3000];
    Float_t         S25Clu[3000];
    Float_t         timeClu[3000];
    Int_t           nCryClu[3000];
    Int_t           indexCryClu[3000][9];
    Int_t           nGoodRecoMatches[3000];
    Int_t           indexBestRecoMatch[3000];
    Float_t         valueBestAngleMatch[3000];
    Float_t         momentumBestTrackMatch[3000];
    Float_t         dxyVertexBestTrackMatch[3000];
    Float_t         dzVertexBestTrackMatch[3000];
    Float_t         sdxyVertexBestTrackMatch[3000];
    Float_t         sdzVertexBestTrackMatch[3000];
    Float_t         dPhiBestAngleMatch[3000];
    Float_t         dThetaBestAngleMatch[3000];
    Float_t         zClu[3000];
    Float_t         outerPtTrackMatch[3000];
    Int_t           bestNoConvertSimIndexEcal[3000];
    Int_t           countNoConvertSimMatchEcal[3000];
    Float_t         bestNoConvertSimAngleEcal[3000];
    Float_t         seedTimeClu[3000];
    Float_t         seedEnergyClu[3000];
    Float_t         recEnergySum[3000];
    Float_t         weightedTimeClu[3000];

    Float_t         s9WidthX[3000];
    Float_t         s9WidthY[3000];
    Float_t         s25WidthX[3000];
    Float_t         s25WidthY[3000];
    //
    // Reco Track variables
    //
    Int_t           mTrack[3000];
    Int_t           recoPurityTrack[3000];
    Float_t         recoPhiDTrack[3000];
    Float_t         recoPtTrack[3000];
    Float_t         recoEtaTrack[3000];
    Float_t         recoPhiTrack[3000];
    Float_t         recoThetaTrack[3000];
    Float_t         recoVxTrack[3000];
    Float_t         recoVyTrack[3000];
    Float_t         recoVzTrack[3000];
    Float_t         recoDxyTrack[3000];
    Float_t         recoDzTrack[3000];
    Float_t         recoSdxyTrack[3000];
    Float_t         recoSdzTrack[3000];
    Int_t           recoChargeTrack[3000];
    ...
    Int_t           kMC[5000];
    Int_t           pdgIdMC[5000];
    Int_t           motherIDMC[5000];
    Int_t           motherIndexMC[5000];
    Int_t           statusMC[5000];
    Float_t         ptMC[5000];
    Float_t         eMC[5000];
    Float_t         etaMC[5000];
    ...
    //
    Int_t           kMerge[10000];
    Int_t           numberDecayVerticesMerge[10000];
    Int_t           numberEarlyDecayMerge[10000];
    Int_t           pdgIdMerge[10000];
    Int_t           primaryTrackMerge[10000];
    Float_t         xParentVertexMerge[10000];
    Float_t         yParentVertexMerge[10000];
    Float_t         rParentVertexMerge[10000];
    Float_t         zParentVertexMerge[10000];
    Float_t         ptMerge[10000];
    Float_t         etaMerge[10000];
    Float_t         phiMerge[10000];
    Float_t         xDecayVertexMerge[10000];
    Float_t         yDecayVertexMerge[10000];
    Float_t         rDecayVertexMerge[10000];
    Float_t         zDecayVertexMerge[10000];
    Float_t         bestAngleMatchMerge[10000];
    Float_t         bestPtMatchMerge[10000];
    Float_t         bestEtaMatchMerge[10000];
    Float_t         bestPhiMatchMerge[10000];
    Int_t           bestPdgIdMatchMerge[10000];
    Int_t           bestGenIndexMatchMerge[10000];
    Int_t           bestEcalIndexMatch[10000];
    Float_t         bestEcalAngleMatch[10000];
    Float_t         bestEcalPhiMatch[10000];
    Float_t         bestEcalDPhiMatch[10000];
    Float_t         bestEcalDEtaMatch[10000];
    Float_t         bestEcalPtMatch[10000];
    ...
    //
    Int_t           kMeson[1000];
    Int_t           pdgIdMeson[1000];
    Int_t           statusMeson[1000];
    Int_t           motherIdMeson[1000];
    Float_t         ptMeson[1000];
    Float_t         etaMeson[1000];
    Float_t         phiMeson[1000];
    Int_t           daughtersFromMeson[1000];
    Int_t           pdgIdDecay1Meson[1000];
    Float_t         ptDecay1Meson[1000];
    Float_t         etaDecay1Meson[1000];
    Float_t         phiDecay1Meson[1000];
    Int_t           mergeDecay1Meson[1000];
    Int_t           convertDecay1Meson[1000];
    Float_t         mergeDecay1Angle[1000];
    Int_t           pdgIdDecay2Meson[1000];
    Float_t         ptDecay2Meson[1000];
    Float_t         etaDecay2Meson[1000];
    Float_t         phiDecay2Meson[1000];
    Int_t           mergeDecay2Meson[1000];
    Int_t           convertDecay2Meson[1000];
    Float_t         mergeDecay2Angle[1000];
    Int_t           pdgIdDecay3Meson[1000];
    Float_t         ptDecay3Meson[1000];
    Float_t         etaDecay3Meson[1000];
    Float_t         phiDecay3Meson[1000];
    Int_t           mergeDecay3Meson[1000];
    Int_t           convertDecay3Meson[1000];
    Float_t         mergeDecay3Angle[1000];
    Float_t         massRecoMeson[1000];
    Float_t         ptRecoMeson[1000];
    Float_t         etaRecoMeson[1000];
    Float_t         phiRecoMeson[1000];

    //
    // simTrack variables
    //
    Int_t           kSim[10000];
    Int_t           noVertexSim[10000];
    Int_t           pdgIdSim[10000];
    Float_t         ptSim[10000];
    Float_t         eSim[10000];
    Float_t         etaSim[10000];
    Float_t         phiSim[10000];
    Int_t           trackIdSim[10000];
    Int_t           parentKSim[10000];
    Int_t           parentIdSim[10000];
    Int_t           parentTrackSim[10000];
    Int_t           gParentKSim[10000];
    Int_t           gParentIdSim[10000];
    Int_t           gParentTrackSim[10000];
    Int_t           nDaughtersSim[10000];
    Int_t           kDaughtersSim[10000][3];
    Float_t         rSim[10000];
    Float_t         zSim[10000];
    Int_t           genPartIndexSim[10000];
    Int_t           genPartPdgIdSim[10000];
    Float_t         bestAngleMatchGenSim[10000];
    Float_t         bestPtMatchGenSim[10000];
    Float_t         bestEtaMatchGenSim[10000];
    Float_t         bestPhiMatchGenSim[10000];
    Int_t           motherGenIndexSim[10000];
    Int_t           motherGenIdSim[10000];
    Int_t           gMotherGenIdSim[10000];
    Int_t           bestNoConvertEcalIndexSim[10000];
    Float_t         bestNoConvertEcalAngleSim[10000];
    Float_t         bestNoConvertEcalPtSim[10000];

    //
    // photon reco and truth
    //
    Int_t           kPhotonGen[2000];
    Int_t           motherPdgIdPhotonGen[2000];
    Float_t         ptMotherPhotonGen[2000];
    Float_t         ptPhotonGen[2000];
    Float_t         etaPhotonGen[2000];
    Float_t         phiPhotonGen[2000];
    Int_t           mergeIndexPhotonGen[2000];
    Int_t           clusterIndexPhotonGen[2000];
    Int_t           convertPhotonGen[2000];
    Float_t         angleRecoPhotonGen[2000];
    Float_t         ptRecoPhotonGen[2000];
    Float_t         etaRecoPhotonGen[2000];
    Float_t         phiRecoPhotonGen[2000];
    ...
    if(iOption == 23 || iOption == -23 || iOption == 24 || iOption == -24 || // Look at 2-dimensional yields of the pi0, as a function of pT and psuedorapidity (23); 1-dimension (24)
       iOption == 25 || iOption == -25 || iOption == 26 || iOption == -26) {  // add eta-548 MeV meson choice
      
      if(!mesonStore) {
        cerr << "\n\n Cannot use option 23 or option 24 or option 25 or option 26 since the mesonStore is set to false" << endl << endl;
        return;
      }
      
      int nBinsOneDimension = 100;
      
      TH2D *generatorPi0Yields = new TH2D("generatorPi0Yields", "Generator #pi^{0} Yields(#eta, p_{T})", 25, 0.5, 5.0, 25, -1.5, 1.5);
      ...
      TH2D *reconstructedPi0Yields = new TH2D("reconstructedPi0Yields", "Reconstructed #pi^{0} Yields(#eta, p_{T})", 25, 0.5, 5.0, 25, -1.5, 1.5);
      ...
      TH2D *efficiencyPi0Yields = new TH2D("efficiencyPi0Yields", "Efficiency(#eta, p_{T}) for #pi^{0} Reconstruction", 25, 0.5, 5.0, 25, -1.5, 1.5);
      ...
      if(iOption == -23 || iOption == -24 || iOption == -25 || iOption == -26) {
      ...
      for (Long64_t i=0; i<entriesToProcess; i++) {
        ...
        for(int jMeson=0; jMeson< nMesonSize; jMeson++) {
          ...
          if(pdgIdMeson[jMeson] == pdgIdMesonChoice && daughtersFromMeson[jMeson] == 2 && fabs(etaMeson[jMeson]) <= etaHighLimit &&
             fabs(etaMeson[jMeson]) >= etaLowLimit && ptMeson[jMeson] > 0.600 && ptMeson[jMeson] < 12.0) {
            if(!allowConversions && (convertDecay1Meson[jMeson] > 0 ||
                                     convertDecay2Meson[jMeson] > 0)) { // suppress conversion cases, if requested
            ...
            if(fabs(etaRecoMeson[jMeson]) < 1.49 && ptRecoMeson[jMeson] > 0.70 && ptRecoMeson[jMeson] < 5.0) {
    ...
    if(iOption == 31 || iOption == -31 || iOption == 32 || iOption == -32 || iOption == 33 || iOption == -33 || iOption == 53 ||
       (iOption >= 54 && iOption <= 60) || (iOption >= 70 && iOption <= 72)) { // 2x2 panel of the mass spectra for pT bins 1.0-1.5, 1.5-2.0, 2.0-2.5, and 2.5-3.0
      ...
      float lowPtBinLimit[4] =  {3.0, 5.0, 0.7, 1.0};
      float highPtBinLimit[4] = {5.0, 8.0, 1.0, 1.5};
	...
	sprintf(histogramName, "correctedPtBin%d", kPt);
      ...
      const float lowLimitPi0Mass = 0.095;
      const float highLimitPi0Mass = 0.175;
	...
	float phiRecoPi0Mass[1000];
	  ...
	  float recEnergyTest = recEnergySum[jClu];
		...
		if(massTest > 0.225 && massTest < 0.275) { // should defer filling the mass histogram until the pi0 pair mass opening angle check is made
		...
		if(massTest > lowLimitPi0Mass && massTest < highLimitPi0Mass) { // should defer filling the mass histogram until the pi0 pair mass opening angle check is made
		  if(pt > lowPtBinLimit[0] && pt < highPtBinLimit[3]) {
		  ...
		  if(countRecoPi0Mass < MAXRECOPI0MASS) {
		    ...
		    phiRecoPi0Mass[countRecoPi0Mass] = atan2(py,px);
		    float pi0Theta = acos(pz/ptot);
		    etaRecoPi0Mass[countRecoPi0Mass] = -log(tan(pi0Theta/2.0));						 
		    countRecoPi0Mass++;
		  } // safety check
		} // check if this looks like a pi0 mass
                for(int kPt=0; kPt<nPtBins; kPt++) { // should defer filling the pT histogram until the pi0 pair mass opening angle check is made
	  ...
	  if(countRecoPi0Mass > 1) {
	    ...
	    for(int kPi0=0; kPi0<countRecoPi0MassMinusOne; kPi0++) {
	      ...
	      if(jClu1 > -1 && jClu1 < 3000 && countNoConvertSimMatchEcal[jClu1] > 0 && bestNoConvertSimAngleEcal[jClu1] < 0.02) {
		...
		if(gMotherGenIdSim[jSim] > -1)
	      ...
	      if(mClu1 > -1 && mClu1 < 3000 && countNoConvertSimMatchEcal[mClu1] > 0 && bestNoConvertSimAngleEcal[mClu1] < 0.02) {
		...
		if(jClu2 > -1 && jClu2 < 3000 && countNoConvertSimMatchEcal[jClu2] > 0 && bestNoConvertSimAngleEcal[jClu2] < 0.02) {
		...
		if(mClu2 > -1 &&  mClu2 < 3000 && countNoConvertSimMatchEcal[mClu2] > 0 && bestNoConvertSimAngleEcal[mClu2] < 0.02) {
	...
	if(useClusterCrystalLimit) {
	  ...
	  sprintf(runLabelText4, "NO cluster crystal limits are used");
	}
	...
	if(iOption == 53) {
	  ...
	  if(simRunEPOS) {
	    sprintf(runLabelText1, "%d Sampled EPOS pPb Min Bias Events", sampledEvents);
          ...
          if(useClusterCrystalLimit) {
            ...
            sprintf(runLabelText4, "NO cluster crystal limits used,");
          }
          ...
          if(useClusterPairCrystalSumLimit) {
            ...
            sprintf(runLabelText4a, "NO pair crystal sum limit used");
          }

	  float xPosition = 0.16;
	  if(iOption == 53) {
	    xPosition = 3.0;
	  }
	  ...
	  if(simRun && useConversionSuppression) {
            TLatex *runLabel6 = new TLatex(0.02, 0.61*maxHistogramValue1, "Using conversion suppression");
            runLabel6->SetTextColor(kMagenta);
	  ...
	  char *runLabelText8 = new char[200];
	  sprintf(runLabelText8, "S4/S9 cut %3.2f", clustS49Cut);
	  TLatex *runLabel8 = new TLatex(0.02, 0.54*maxHistogramValue1, runLabelText8);
	  runLabel8->SetTextColor(kRed);
	  runLabel8->SetTextSize(0.045);
	  runLabel8->Draw();
    ...
    if(iOption == 34 || iOption == 35  || iOption == -35 || iOption == 36 || iOption == 37 || iOption == 38) { // check energy asymmetry parameter for the pi0 or the eta-meson decay photons
	...
	if(countNeutralPions > 1) {
	  ...
	  for(int jMeson=0; jMeson<jMesonHighLimit; jMeson++) {
	    ...
	    for(int mMeson=mMesonLowLimit; mMeson<countNeutralPions; mMeson++) {
	      ...
	      float deltaPhi = neutralPionPhiArray[mMeson] - firstPhi;
	      deltaPhi = asin(deltaPhi);
	      neutralNeutralCorrelation->Fill(deltaEta, deltaPhi);
	    } // inner mMeson loop
	  } // outer jMeson loop
	...
	if(countNeutralPions > 0 && countChargedPions > 0) {
	  for(int jMeson=0; jMeson<countChargedPions; jMeson++) {
	    ...
	    for(int mMeson=0; mMeson<countChargedPions; mMeson++) {
	      ...
	      float deltaPhi = chargedPionPhiArray[mMeson] - firstPhi;
	      deltaPhi = asin(deltaPhi);
	      neutralChargedCorrelation->Fill(deltaEta, deltaPhi);
	    } // inner mMeson loop
	  } // outer jMeson loop
	...
	if(countChargedPions > 1) {
	  ...
	  for(int jMeson=0; jMeson<jMesonHighLimit; jMeson++) {
	    ...
	    for(int mMeson=mMesonLowLimit; mMeson<countChargedPions; mMeson++) {
	      ...
	      float deltaPhi = chargedPionPhiArray[mMeson] - firstPhi;
	      deltaPhi = asin(deltaPhi);
	      chargedChargedCorrelation->Fill(deltaEta, deltaPhi);
	    } // inner mMeson loop
	  } // outer jMeson loop
	...
	if(countNonResonancePions > 1) {
	  ...
	  for(int jMeson=0; jMeson<jMesonHighLimit; jMeson++) {
	    ...
	    for(int mMeson=mMesonLowLimit; mMeson<countNonResonancePions; mMeson++) {
	      ...
	      float deltaPhi = nonResonancePionPhiArray[mMeson] - firstPhi;
	      deltaPhi = asin(deltaPhi);
	      if(firstPt > jetPt || nonResonancePionPtArray[mMeson] > jetPt) {
		nonResonancePi0Correlation->Fill(deltaEta, deltaPhi);
	...
	if(lastCountNonResonancePions > 0) {
	  if(countNonResonancePions > 0) {
		...
		deltaPhi = asin(deltaPhi);
		if(firstPt > jetPt || nonResonancePionPtArray[mMeson] > jetPt) {
		  nonResonanceMixedCorrelation->Fill(deltaEta, deltaPhi);
    ...
    if(iOption == 45) { // study of HBT pairs correlations 
     ...
     int nqBins = 100;
      ...
      const double lowLimitPi0Mass =  0.134976 - pi0MassWindow;
      const double highLimitPi0Mass = 0.134976 + pi0MassWindow;;
	...
	float phiRecoPi0Mass[1000];
	  ...
	  countRecoPi0 = 0;
		...
		//
		if(pt > lowPi0PtCut && pt < highPi0PtCut && massTest > lowLimitPi0Mass  && massTest < highLimitPi0Mass) {
