...
my $topName = "/gpfs22/home/maguirc/CMSSW_5_3_8_patch2/src/Pi0Analysis/EcalFlowNtp/pPbRun2013";
if(-e $topName) {
...
my $storeDirectory = "/gpfs22/home/maguirc/CMSSW_5_3_8_patch2/src/Pi0Analysis/EcalFlowNtp/pPbRun2013/crab_0_130805_092228/res/";
if(-e $storeDirectory) {
...
#
# Generate the list of files in this GPFS area (assume that the files have a 3August2013 in their names)
#
`ls -al $storeDirectory | grep "3August2013" > gpfsFilesList.txt`;
