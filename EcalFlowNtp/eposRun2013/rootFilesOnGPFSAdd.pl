...
my $topName = "/gpfs22/home/maguirc/CMSSW_5_3_8_HI_patch2/src/Pi0Analysis/EcalFlowNtp/eposRun2013";
if(-e $topName) {
...
my $storeDirectory = "/gpfs22/home/maguirc/CMSSW_5_3_8_HI_patch2/src/Pi0Analysis/EcalFlowNtp/eposRun2013/epos1_4Peak/";
if(-e $storeDirectory) {
...
#
`ls -al $storeDirectory | grep TrueV > gpfsFilesList.txt`;
