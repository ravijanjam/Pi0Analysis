...
EcalFlowNtp = cms.EDAnalyzer("EcalFlowNtp",
    ...
    useClusterCrystalLimitLowPtOnly = cms.bool(False),                        
    clusterCrystalLimitLowPtOnly = cms.double( 0.0 ),     
    ...
    simSlimTrackStore = cms.bool(False),                        
    ...
    chmesonStore = cms.bool(False),
    pairCorrTracksStore = cms.bool(False),                             
