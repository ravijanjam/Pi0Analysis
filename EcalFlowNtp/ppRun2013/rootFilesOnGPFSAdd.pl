...
my $topName = "/gpfs22/home/maguirc/CMSSW_5_3_8_HI_patch2/src/Pi0Analysis/EcalFlowNtp/ppRun2013";
if(-e $topName) {
...
my $storeDirectory = "/gpfs22/home/maguirc/CMSSW_5_3_8_HI_patch2/src/Pi0Analysis/EcalFlowNtp/ppRun2013/crab_0_140116_172905/res/";
if(-e $storeDirectory) {
...
#
# Generate the list of files in this GPFS area (assume that the files have a pp_MinBiasHighMassReCalWithSuppression_23Jul in their names)
#
`ls -al $storeDirectory | grep "pp_MinBiasHighMassReCalWithSuppression_16Jan" > gpfsFilesList.txt`;
...
while(<INPUTLIST>) {
	...
	print "\n first output file set $newOutputFileName";
