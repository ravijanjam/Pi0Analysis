...
# Working directory
#
my $topName = "/gpfs22/home/maguirc/CMSSW_5_3_8_HI_patch2/src/Pi0Analysis/EcalFlowNtp/";
if(-e $topName) {
...
#
# Success mode arrays (printSuccessResult should be 1)
#
my $printSuccessResults = 0;
